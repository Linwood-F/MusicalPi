...
#define MUSICALPI_DEBUG_MIDI_SEND_DETAILS  true
#define MUSICALPI_DEBUG_MIDI_FILE_PARSE_DETAILS  true
#define MUSICALPI_DEBUG_MIDI_MEASURE_DETAILS  true
#define MUSICALPI_DEBUG_QUEUE_INFO_INTERVAL 500  // Time in ms between output of queue information in debug

// Midi output changes

#define MUSICALPI_MIDI_QUASH_RESET_ALL  true  // My piano misses the next note if these are sent
